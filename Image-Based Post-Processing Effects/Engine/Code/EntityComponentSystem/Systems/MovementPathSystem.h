...
class MovementPathSystem : public System<MovementPathSystem>, IOnComponentAddedListener, IOnComponentRemovedListener, IOnEntityDestructionListener
{
public:
	explicit MovementPathSystem();
	void init() override;
